<template>
  <div class="reg-user-center">
    ...
    <el-card>
      ...
      <div class="actions">
        <el-button type="primary" @click="openPwd">修改密码</el-button>
        <el-button @click="openPrefs">偏好设置</el-button>
      </div>
...
const openPrefs = () => showPrefs.value = true;
