...
router.get('/alerts', vehicleSafetyController.getAlertList);
router.get('/alerts/count', vehicleSafetyController.getAlertCount);
router.put('/alerts/:id/handle', vehicleSafetyController.markAlertHandled);
